...
python3 /cs/usr/franziska/Documents/ReinforcementLearning/Snake.py \
    -P "Avoid(epsilon=0.5);Avoid(epsilon=0.2);MyPolicy(learning_rate=0.01)" \
...
python3 /cs/usr/franziska/Documents/ReinforcementLearning/Snake.py \
    ...
    -D 7000 -s 1000 -r 0 -plt 0.11 -pat 0.015 -pit 60 \
...
python3 /cs/usr/franziska/Documents/ReinforcementLearning/Snake.py \
    -P "Avoid(epsilon=0.5);Avoid(epsilon=0.2);MyPolicy(epsilon=0.3);MyPolicy(epsilon=0.3);MyPolicy(epsilon=0.4)"
    -D 7000 -s 1000 -r 0 -plt 0.01 -pat 0.005 -pit 60 \
